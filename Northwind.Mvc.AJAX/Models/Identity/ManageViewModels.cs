...
namespace EasyLOB.Identity.Mvc
{
    ...
    public class SetPasswordViewModel
    {
        ...
        [StringLength(100, ErrorMessageResourceName = "NewPasswordError", ErrorMessageResourceType = typeof(AccountResources), MinimumLength = 6)]
        ...
        [Compare("NewPassword", ErrorMessageResourceName = "ConfirmPasswordError", ErrorMessageResourceType = typeof(AccountResources))]
